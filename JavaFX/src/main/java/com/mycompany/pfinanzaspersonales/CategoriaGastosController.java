...
public class CategoriaGastosController implements Initializable {
    
    @FXML private TableView tabla_gastos;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            for(int i =0; i < jsonArr.length(); i++){
                ...
                categoria.add(new CategoriaProductos( data_json.get("nom_cat_gastos").toString() ));
            }

            tabla_gastos.setItems( FXCollections.observableArrayList(categoria) );
